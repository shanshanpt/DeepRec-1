...
#include "tensorflow/contrib/parquet/arrow/arrow.h"
#include "tensorflow/contrib/parquet/arrow/common/arrow.h"
#include "tensorflow/contrib/parquet/arrow/parquet_batch_reader.h"
...
class ParquetBatchReader::Impl {
 public:
  ...
  Status Open() {
    ...
    TF_RETURN_IF_ARROW_ERROR(::tensorflow::arrow::OpenArrowFile(&file, filename_));
    TF_RETURN_IF_ARROW_ERROR(
        ::tensorflow::arrow::OpenParquetReader(&reader_, file));
