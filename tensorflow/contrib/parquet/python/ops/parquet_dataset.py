...
from tensorflow.contrib.parquet.python.ops.parquet import parquet_filenames_and_fields
...
class _ParquetDataset(dataset_ops.DatasetSource):  # pylint: disable=abstract-method
  ...
  def __init__(
    ...
    variant_tensor = gen_dataset_ops.parquet_tabular_dataset(
        self._filename,
        self._batch_size,
    ...
    super(_ParquetDataset, self).__init__(variant_tensor)
...
class ParquetDataset(dataset_ops.DatasetV2):  # pylint: disable=abstract-method
  ...
  def __init__(
    ...
    super(ParquetDataset, self).__init__(self._impl._variant_tensor)  # pylint: disable=protected-access
